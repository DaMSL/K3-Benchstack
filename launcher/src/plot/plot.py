...
def plotScalability(isColor=True):
  utils.checkDir('../web/scalability_graphs')
  utils.buildIndex('../web/scalability_graphs', 'Scalability')
  ...
  plotTimePerCore(time_per_cores, '../web/scalability_graphs/tpch_per_core.jpg', keyFn, displayFn)
  plotRawTimes(avg_times, '../web/scalability_graphs/tpch.jpg', keyFn, displayFn)
  ...
  plotTimePerCore(time_per_cores, '../web/scalability_graphs/ml_per_core.jpg', keyFn, displayFn)
  plotRawTimes(avg_times, '../web/scalability_graphs/ml.jpg', keyFn, displayFn)
